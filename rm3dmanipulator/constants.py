...
field_index = { 'bondFuture': {'ignore_fx_index': 17, 'discount_curve_index': 4},
                'cap': {'ignore_fx_index': 17, 'discount_curve_index': 26, 'tags_index': 16},
                'cash': {'ignore_fx_index': 5, 'discount_curve_index': None},
                'cashFlow': {'ignore_fx_index': 4, 'discount_curve_index': 2, 'tags_index': 3},
                'creditDefaultSwap': {'ignore_fx_index': 25, 'discount_curve_index': 9},
                'equity': {'ignore_fx_index': 11, 'discount_curve_index': None},
                'floor': {'ignore_fx_index': 17, 'discount_curve_index': 26},
                'fxOption': {'ignore_fx_index': 15, 'discount_curve_index': None},
